...
Out of the box, Android 4.1 (and even some newer releases apparently) ship with the Browser server as the default web browser of choice (as opposed to Chrome). Unfortunately, the Browser server has lots of bugs and inconsistencies with CSS in general.
